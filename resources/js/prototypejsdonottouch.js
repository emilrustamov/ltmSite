!(function (e) {
  function t(t) {
    for (var i, s, r = t[0], a = t[1], o = 0, c = []; o < r.length; o++)
      (s = r[o]),
  ...
  (s.e = function (e) {
    ...
    (s.p = "/wp-content/themes/masha/js/"),
    (s.oe = function (e) {
  ...
  function (e, t, i) {
    ...
    var n = {
      ...
      generateId: function (e) {
        ...
        return (e.id =
          e.id || t + "-" + Math.random().toString(36).substr(2, 9));
      },
        ...
        var t = e.innerHTML.trim(),
          i = n.debounce(function () {
            ...
            e.querySelectorAll("span").forEach(function (e, t) {
              (null === n || e.offsetTop > n) && (s[s.length] = []),
                s[s.length - 1].push(i[t]),
                (n = e.offsetTop);
            }),
              (e.innerHTML = s
                .map(function (e) {
  ...
  function (e, t, i) {
    ...
    function h(e, t) {
      var i = u(e),
        n = o(d.und(i[0]) ? 1 : i[0], 0.1, 100),
        s = o(d.und(i[1]) ? 100 : i[1], 0.1, 100),
        r = o(d.und(i[2]) ? 10 : i[2], 0.1, 100),
        l = o(d.und(i[3]) ? 0 : i[3], 0.1, 100),
        c = Math.sqrt(s / n),
        h = r / (2 * Math.sqrt(s * n)),
    ...
    function I(e, t) {
      return d.dom(e) && !d.inp(e) && (P(e, t) || (d.svg(e) && e[t]))
        ? "attribute"
        : d.dom(e) && S(r, t)
        ? "transform"
        : d.dom(e) && "transform" !== t && A(e, t)
        ? "css"
        : null != e[t]
        ? "object"
        : void 0;
    ...
    function D(e, t, i, n) {
      var s = l(t, "scale")
        ...
        r = B(e).get(t) || s;
      return (
        i && (i.transforms.list.set(t, r), (i.transforms.last = t)),
        n ? z(e, r, n) : r
      );
    }
    ...
    function F(e, t) {
      ...
      return s
        .map(function (e, i) {
          ...
          return (
            d.und(n.delay) && (n.delay = i ? 0 : t.delay),
            d.und(n.endDelay) &&
              (n.endDelay = i === s.length - 1 ? t.endDelay : 0),
            n
          );
        })
        .map(function (e) {
              ...
              var t = w(
                ...
                n = function (n) {
                  ...
                  i[s] = e.map(function (e) {
                    var t = {};
                    for (var i in e)
                      d.key(i) ? i == s && (t.value = e[i]) : (t[i] = e[i]);
                    return t;
                  });
                },
                s = 0;
    ...
    function U(e, t) {
      ...
      return e.tweens.map(function (n) {
        ...
        return (
          ...
          (s.easing = y(s.easing, s.duration)),
          (s.isPath = d.pth(r)),
          (s.isColor = d.col(s.from.original)),
          s.isColor && (s.round = 1),
          (i = s),
          s
        );
    ...
    function re(e) {
      ...
      function m(e) {
        for (var t = 0, i = u.animations, n = i.length; t < n; ) {
          ...
          for (
            var d = o(e - c.start - c.delay, 0, c.duration) / c.duration,
              h = isNaN(d) ? 1 : c.easing(d),
              p = c.to.strings,
              f = c.round,
              v = [],
            ...
            (b = c.isPath ? q(c.value, h * E) : x + h * (E - x)),
          ...
          K[s.type](r.target, s.property, g, r.transforms),
            (s.currentValue = g),
            t++;
        }
      }
      ...
      function y(e) {
        var n = u.duration,
          ...
          f = n - u.endDelay,
          y = p(e);
        (u.progress = o((y / n) * 100, 0, 100)),
          (u.reversePlayback = y < u.currentTime),
          t &&
            (function (e) {
              if (u.reversePlayback) for (var i = l; i--; ) v(e, t[i]);
          ...
          y <= s && 0 !== u.currentTime && m(0),
          ((y >= f && u.currentTime !== n) || !n) && m(n),
          y > s && y < f
            ? (u.changeBegan ||
                ((u.changeBegan = !0),
                (u.changeCompleted = !1),
    ...
    function ae(e, t) {
      for (var i = t.length; i--; )
        S(e, t[i].animatable.target) && t.splice(i, 1);
    }
    "undefined" != typeof document &&
      ...
      (re.stagger = function (e, t) {
        ...
        return function (e, t, d) {
          if (
            (o && (a = 0), l && (a = (d - 1) / 2), c && (a = d - 1), !m.length)
          ) {
            for (var y = 0; y < d; y++) {
              if (s) {
        ...
        return (
          ...
          (t.add = function (i, n) {
            ...
            (c.autoplay = !1),
              ...
              (c.timelineOffset = d.und(n) ? u : _(n, u)),
              o(t),
    ...
    (r = function () {
      ...
      var r = {
        ...
        parents: function (e) {
          for (var t = [], i = 0; i < this.length; i += 1)
            for (var r = this[i].parentNode; r; )
              e ? n(r).is(e) && t.push(r) : t.push(r), (r = r.parentNode);
          return n(s(t));
        },
        closest: function (e) {
          var t = this;
        ...
        find: function (e) {
          for (var t = [], n = 0; n < this.length; n += 1)
            for (
              var s = this[n].querySelectorAll(e), r = 0;
              r < s.length;
              r += 1
            )
              t.push(s[r]);
      ...
      var o = {
          ...
          extend: function () {
            ...
            for (var i = Object(e[0]), n = 1; n < e.length; n += 1) {
              ...
              if (null != s)
                for (
                  var r = Object.keys(Object(s)), a = 0, l = r.length;
                  a < l;
                  a += 1
                ) {
                  var c = r[a],
                  ...
                  void 0 !== d &&
                    d.enumerable &&
                    (o.isObject(i[c]) && o.isObject(s[c])
                      ? o.extend(i[c], s[c])
                      : !o.isObject(i[c]) && o.isObject(s[c])
                      ? ((i[c] = {}), o.extend(i[c], s[c]))
                      : (i[c] = s[c]));
                }
            }
            return i;
      ...
      (c.prototype.on = function (e, t, i) {
        ...
        (c.prototype.emit = function () {
          ...
          "string" == typeof e[0] || Array.isArray(e[0])
            ? ((i = e[0]), (n = e.slice(1, e.length)), (s = r))
            : ((i = e[0].events), (n = e[0].data), (s = e[0].context || r));
        ...
        (c.installModule = function (e) {
          ...
          var s =
            e.name || Object.keys(n.prototype.modules).length + "_" + o.now();
          return (
      ...
      var u,
              ...
              for (
                ...
                if (e.slidesPerColumn > 1) {
                  ...
                  if ("row" === e.slidesPerColumnFill && e.slidesPerGroup > 1) {
                    var B = Math.floor(
                        O / (e.slidesPerGroup * e.slidesPerColumn)
                      ),
                      ...
                      $ =
                        0 === B
                          ? e.slidesPerGroup
                          : Math.min(
                              Math.ceil((d - B * k * e.slidesPerGroup) / k),
                              e.slidesPerGroup
                            );
                    (z =
                      (A =
                    ...
                    "column" === e.slidesPerColumnFill
                      ? ((I = O - (A = Math.floor(O / k)) * k),
                        (A > L || (A === L && I === k - 1)) &&
                          (I += 1) >= k &&
                          ((I = 0), (A += 1)))
                      : (A = O - (I = Math.floor(O / M)) * M);
                  P.css(
                ...
                if ("none" !== P.css("display")) {
                  if ("auto" === e.slidesPerView) {
                    ...
                    if (
                      ...
                      N && (P[0].style.webkitTransform = "none"),
                      e.roundLengths)
                    )
                      C = this.isHorizontal()
                        ? P.outerWidth(!0)
                      ...
                      C =
                        W && "border-box" === W ? X + q + G : X + Y + H + q + G;
                    } else {
                      ...
                      C =
                        Q && "border-box" === Q ? R + U + K : R + F + V + U + K;
                    }
                    j && (P[0].style.transform = j),
                      N && (P[0].style.webkitTransform = N),
                      e.roundLengths && (C = Math.floor(C));
                  } else
                    (C = (n - (e.slidesPerView - 1) * b) / e.slidesPerView),
                      e.roundLengths && (C = Math.floor(C)),
                      c[O] &&
                        (this.isHorizontal()
                          ? (c[O].style.width = C + "px")
                          : (c[O].style.height = C + "px"));
              ...
              if (
                ...
                for (var J = 0; J < u.length; J += 1) {
                  ...
                  e.roundLengths && (Z = Math.floor(Z)),
                    u[J] < this.virtualSize + u[0] && T.push(Z);
                }
                u = T;
              }
              if (!e.centeredSlides) {
                ...
                for (var ee = 0; ee < u.length; ee += 1) {
                  ...
                  e.roundLengths && (te = Math.floor(te)),
                    u[ee] <= this.virtualSize - n && T.push(te);
                }
                (u = T),
        ...
        O = {
          slideTo: function (e, t, i, n) {
            ...
            if ((r.updateProgress(m), o.normalizeSlideIndex))
              for (var g = 0; g < c.length; g += 1)
                -Math.floor(100 * m) >= Math.floor(100 * c[g]) && (a = g);
          ...
          slideToClosest: function (e, t, i, n) {
            ...
            if (a >= this.snapGrid[r]) {
              ...
              a - o > (this.snapGrid[r + 1] - o) * n &&
                (s += this.params.slidesPerGroup);
            } else {
              var l = this.snapGrid[r - 1];
              a - l <= (this.snapGrid[r] - l) * n &&
                (s -= this.params.slidesPerGroup);
            }
            return (
              (s = Math.max(s, 0)),
              (s = Math.min(s, this.snapGrid.length - 1)),
        ...
        P = {
          loopCreate: function () {
            ...
            for (var h = c.length - 1; h >= 0; h -= 1)
              s.prepend(n(c[h].cloneNode(!0)).addClass(i.slideDuplicateClass));
          },
          loopFix: function () {
            var e,
              t = this.activeIndex,
        ...
        A = {
          appendSlide: function (e) {
            ...
            if (
              ...
              "object" === (void 0 === e ? "undefined" : a(e)) && "length" in e)
            )
          ...
          prependSlide: function (e) {
            ...
            t.loop && this.loopCreate(),
              (t.observer && l.observer) || this.update(),
              this.slideTo(s, 0, !1);
          },
          addSlide: function (e, t) {
            ...
            if (e <= 0) this.prependSlide(t);
              ...
              n.loop && this.loopCreate(),
                (n.observer && l.observer) || this.update(),
                n.loop
        ...
        I =
          ...
          (b = !g && h.match(/(iPhone\sOS|iOS)\s([\d_]+)/)),
          (w = h.indexOf("MSIE ") >= 0 || h.indexOf("Trident/") >= 0),
          (E = h.indexOf("Edge/") >= 0),
          ...
          m &&
            ...
            (p.osVersion = m[2]),
            (p.android = !0),
            (p.androidChrome = h.toLowerCase().indexOf("chrome") >= 0)),
          (g || b || y) && ((p.os = "ios"), (p.ios = !0)),
          b && !y && ((p.osVersion = b[2].replace(/_/g, ".")), (p.iphone = !0)),
          g && ((p.osVersion = g[2].replace(/_/g, ".")), (p.ipad = !0)),
          y &&
          ...
          p.ios &&
            ...
            (p.osVersion = h.toLowerCase().split("version/")[1].split(" ")[0]),
          (p.webView =
            !(
              !(b || g || y) ||
              (!h.match(/.*AppleWebKit(?!.*Safari)/i) &&
            ...
            if (
              ...
              if (!h || !(d <= p || d >= t.screen.width - p)) {
                if (
                  ...
                  var v =
                    f && this.allowTouchMove && r.touchStartPreventDefault;
      ...
      function $(e) {
        ...
        if (
          ...
          if (n.freeMode) {
            ...
            if (n.freeModeMomentum) {
              ...
              if (
                ...
                if (
                  ...
                  y =
                    M < L ? n.speed : M < 2 * L ? 1.5 * n.speed : 2.5 * n.speed;
                }
            ...
            for (
              var O = 0, P = t.slidesSizesGrid[0], z = 0;
              z < l.length;
              z += n.slidesPerGroup
            )
              void 0 !== l[z + n.slidesPerGroup]
                ? u >= l[z] &&
                  u < l[z + n.slidesPerGroup] &&
                  ((O = z), (P = l[z + n.slidesPerGroup] - l[z]))
                : u >= l[z] &&
                  ((O = z), (P = l[l.length - 1] - l[l.length - 2]));
            var A = (u - l[O]) / P;
            if (p > n.longSwipesMs) {
              if (!n.longSwipes) return void t.slideTo(t.activeIndex);
              "next" === t.swipeDirection &&
                (A >= n.longSwipesRatio
                  ? t.slideTo(O + n.slidesPerGroup)
                  : t.slideTo(O)),
      ...
      var H = {
              ...
              if (!l.touch && l.pointerEvents)
                ...
                if (l.touch) {
                  ...
                  n.addEventListener(i.start, this.onTouchStart, a),
                    ...
                    X || (e.addEventListener("touchstart", Y), (X = !0));
                }
                ((t.simulateTouch && !I.ios && !I.android) ||
                  (t.simulateTouch && !l.touch && I.ios)) &&
              ...
              if (!l.touch && l.pointerEvents)
                ...
                if (l.touch) {
                  ...
                  n.removeEventListener(i.start, this.onTouchStart, a),
                    n.removeEventListener(i.move, this.onTouchMove, r),
        ...
        W = (function (e) {
          function t() {
            for (var i, s, r, c = [], d = arguments.length; d--; )
              c[d] = arguments[d];
            ...
            u.useModulesParams(h),
              (u.params = o.extend({}, h, G, r)),
              (u.originalParams = o.extend({}, u.params)),
              (u.passedParams = o.extend({}, r)),
              (u.$ = n);
            var p = n(u.params.el);
            if ((s = p[0])) {
              if (p.length > 1) {
              ...
              return (
                ...
                s && s.shadowRoot && s.shadowRoot.querySelector
                  ? ((v = n(
                      s.shadowRoot.querySelector("." + u.params.wrapperClass)
                    )).children = function (e) {
                      return p.children(e);
                    })
              ...
              if (
                ...
                if (
                  ...
                  d.each(function (e, s) {
                    var r = n(s),
                      a = r.index();
                    a === i && r.addClass(t.bulletActiveClass),
                      t.dynamicBullets &&
                        (a >= o &&
                          a <= l &&
          ...
          onTouchMove: function (e) {
            ...
            if (
              ...
              n.isMoved ||
                ...
                (n.startX = o.getTranslate(i.$imageWrapEl[0], "x") || 0),
                (n.startY = o.getTranslate(i.$imageWrapEl[0], "y") || 0),
      ...
      "object" === a(t) && void 0 !== e
        ? (e.exports = r())
        : void 0 ===
            (s = "function" == typeof (n = r) ? n.call(t, i, t, e) : n) ||
          (e.exports = s);
  },
  function (e, t, i) {
    var n, s;
            ...
            [
              {
                ...
                value: function () {
                  r(this.modal),
                    ...
                    this.modal.setAttribute("aria-hidden", !1),
                    this.onShow();
                },
              },
              {
  ...
  function (e, t, i) {
    ...
    (n = function () {
      ...
      function t(t) {
        ...
        var s,
          a = i(/(ipod|iphone|ipad)/i).toLowerCase(),
        ...
        /opera/i.test(t)
          ...
          ? ((s = {
            ...
            b
              ? ((s.msedge = e), (s.version = b))
              : ((s.msie = e), (s.version = i(/iemobile\/(\d+(\.\d+)?)/i))))
          ...
          ? ((s = {
            ...
            /\((mobile|tablet);[^\)]*rv:[\d\.]+\)/i.test(t) &&
              ((s.firefoxos = e), (s.osname = "Firefox OS")))
          : u
          ? (s = {
              name: "Amazon Silk",
              silk: e,
          ...
          ? ((s = {
            ...
            /touchpad\//i.test(t) && (s.touchpad = e))
          : /bada/i.test(t)
          ? (s = {
              name: "Bada",
              osname: "Bada",
          ...
          !s.msedge && /(apple)?webkit/i.test(t)
            ? (/(apple)?webkit\/537\.36/i.test(t)
                ? ((s.name = s.name || "Blink"), (s.blink = e))
                : ((s.name = s.name || "Webkit"), (s.webkit = e)),
              !s.version && w && (s.version = w))
            : !s.opera &&
              /gecko\//i.test(t) &&
              ((s.name = s.name || "Gecko"),
              (s.gecko = e),
              (s.version = s.version || i(/gecko\/(\d+(\.\d+)?)/i))),
          s.windowsphone || (!o && !s.silk)
            ? !s.windowsphone && a
              ? ((s[a] = e), (s.ios = e), (s.osname = "iOS"))
              : g
              ? ((s.mac = e), (s.osname = "macOS"))
              : S
              ? ((s.xbox = e), (s.osname = "Xbox"))
              : m
              ? ((s.windows = e), (s.osname = "Windows"))
              : y && ((s.linux = e), (s.osname = "Linux"))
            : ((s.android = e), (s.osname = "Android"));
        var C = "";
        s.windows
          ? (C = (function (e) {
              switch (e) {
          ...
          : s.windowsphone
          ? (C = i(/windows phone (?:os)?\s?(\d+(\.\d+)*)/i))
          : s.mac
          ? (C = (C = i(/Mac OS X (\d+([_\.\s]\d+)*)/i)).replace(/[_\s]/g, "."))
          : a
          ? (C = (C = i(/os (\d+([_\s]\d+)*) like mac os x/i)).replace(
              /[_\s]/g,
              "."
            ))
          : o
          ? (C = i(/android[ \/-](\d+(\.\d+)*)/i))
          : s.webos
          ? (C = i(/(?:web|hpw)os\/(\d+(\.\d+)*)/i))
          : s.blackberry
          ? (C = i(/rim\stablet\sos\s(\d+(\.\d+)*)/i))
          : s.bada
          ? (C = i(/bada\/(\d+(\.\d+)*)/i))
          : s.tizen && (C = i(/tizen[\/\s](\d+(\.\d+)*)/i)),
          C && (s.osversion = C);
        var T = !s.windows && C.split(".")[0];
        return (
          E || c || "ipad" == a || (o && (3 == T || (T >= 4 && !x))) || s.silk
            ? (s.tablet = e)
            : (x ||
                "iphone" == a ||
                "ipod" == a ||
          ...
          (s.vivaldi && s.version >= 1) ||
          (s.chrome && s.version >= 20) ||
          (s.samsungBrowser && s.version >= 4) ||
          (s.whale && 1 === r([s.version, "1.0"])) ||
          (s.mzbrowser && 1 === r([s.version, "6.0"])) ||
          (s.focus && 1 === r([s.version, "1.0"])) ||
  ...
  function (e, t, i) {
    ...
    var o,
      ...
      h = c.deligate;
    document.documentElement.style.setProperty("--scrollbar-width", u() + "px"),
      (o = function (e) {
        e
      ...
      i(12),
      i(13)(document.getElementsByTagName("textarea"));
    var p = i(6);
    ["webkit", "blink", "ios", "safari", "msie", "gecko"].forEach(function (e) {
      return p[e] ? document.documentElement.classList.add("is-" + e) : "";
    }),
      i(15),
      document.body.classList.contains("home") && i(16),
      document.getElementById("portfolio-modal") &&
        Promise.all([i.e(0), i.e(6)])
          .then(function () {
            i(20);
          })
          .catch(i.oe),
      new n.default('[data-slider="block-slider"]', {
        speed: 700,
        loop: !0,
        zoom: !0,
        slidesPerView: "auto",
      ...
      s.default.initAll(),
      r.default.initAll(),
      document.querySelectorAll("[data-separate-word]").forEach(function (e) {
        d(e);
      }),
      document
          ...
          return (
            ...
            (t.forEach(function (e) {
              e.classList.add("invalid"),
                e.parentNode.classList.add("has-invalid");
            }),
            !1)
          );
        }
          ...
          if (t()) {
            ...
            fetch("/wp-content/themes/masha/feedback.php", {
              ...
              .then(function (t) {
                ...
                (i.modal.querySelector(".success-modal-message").innerHTML = t),
                  i.open(),
                  e.reset(),
                  e.classList.remove("loading");
              });
          } else
            e.classList.add("has-invalids"), e.addEventListener("input", t);
        });
      });
    var f = i(19),
      v = void 0;
    ...
    m(),
      document.querySelectorAll("[data-catalog]").forEach(function (e) {
        var t = e.querySelector("[data-catalog-list]"),
          n = e.querySelector("[data-catalog-pagination]"),
          s =
            (e.querySelector("[data-catalog-filters]"),
            e.querySelectorAll("[data-catalog-update]")),
          r = void 0;
        ...
        function a(e, i, a) {
          ...
          (o.innerHTML = e),
            s.forEach(function (e) {
              e.innerHTML = o.querySelector(
                '[data-catalog-update="' + e.dataset.catalogUpdate + '"]'
              ).innerHTML;
            }),
            a &&
              r &&
              (r.remove(t.querySelectorAll("[data-catalog-item]")), r.layout());
        ...
        t.hasAttribute("data-catalog-masonry") &&
          i
            .e(2)
            .then(function () {
              var e = [i(21)];
              (function (e) {
                f(t, function () {
                  r = new e(t, {
                    ...
                    columnWidth: t.querySelector("[data-catalog-sizer]")
                      ? "[data-catalog-sizer]"
                      : "",
                    percentPosition: !0,
                  });
              ...
              e.preventDefault(),
                ...
                fetch(t.href, {
                  ...
                  .then(function (e) {
                    a(e, t, !0),
                      document
                        .querySelectorAll("[data-catalog-cats] a")
                        .forEach(function (e) {
      ...
      document.querySelectorAll("[data-like]").forEach(function (e) {
        return e.addEventListener("click", function (t) {
          t.preventDefault(),
            ...
            fetch("/wp-json/blog-api/v1/like/add?id=" + e.dataset.like)
              .then(function (e) {
                return e.text();
              })
              .then(function (t) {
                (e.querySelector("span").innerHTML = t + " likes"),
                  e.classList.remove("loading");
              });
        });
      }),
      document.documentElement.classList.add("loaded", "loaded-page"),
      (!matchMedia("screen and (min-width: 550px)").matches &&
        document.body.classList.contains("home")) ||
        Promise.all([i.e(0), i.e(3), i.e(5)])
          .then(function () {
            i(22);
          })
          .catch(i.oe);
          ...
          e.exports = (function () {
            ...
            try {
              window.sessionStorage.getItem("what-input") &&
                (i = window.sessionStorage.getItem("what-input")),
                window.sessionStorage.getItem("what-intent") &&
                  (n = window.sessionStorage.getItem("what-intent"));
            } catch (e) {}
            var s = null,
            ...
            var m = function () {
                ...
                if (!d) {
                  ...
                  if (n !== s && h) {
                    ...
                    if (
                      p &&
                      p.nodeName &&
                      -1 === r.indexOf(p.nodeName.toLowerCase())
                    ) {
                      n = s;
                      try {
              ...
              w = function (i) {
                i.target.nodeName
                  ? ((t = i.target.nodeName.toLowerCase()),
                    e.setAttribute("data-whatelement", t),
                    i.target.classList &&
                      i.target.classList.length &&
                      e.setAttribute(
                        "data-whatclasses",
                        i.target.classList.toString().replace(" ", ",")
                      ))
                  : E();
              },
              E = function () {
              ...
              T = function (e) {
                for (var t = 0, s = a.length; t < s; t++)
                  a[t].type === e &&
                    a[t].fn.call(void 0, "input" === e ? i : n);
              },
              k = function (e) {
                h.x !== e.screenX || h.y !== e.screenY
                  ? ((u = !1), (h.x = e.screenX), (h.y = e.screenY))
                  : (u = !0);
              };
            return (
              "addEventListener" in window &&
                Array.prototype.indexOf &&
                ((c[C()] = "mouse"), m(), y("input"), y("intent")),
              {
                ask: function (e) {
                  return "intent" === e ? n : i;
                },
      ...
      u = (function () {
        function e() {
          ...
          !(function (e, t) {
            ...
            (t = Object.assign(
              t,
              this.target.dataset.toggleTarget &&
                JSON.parse(this.target.dataset.toggleTarget)
            )),
            (this.id = (0, s.generateId)(this.target, "toggle-target")),
            (this.siblingTogglers = t.siblingTogglers),
            (this.mediaQuery = t.mediaQuery),
            (this.preventScroll = t.preventScroll),
            (this.setHeight = t.setHeight),
            (this.hashTrigger = t.hashTrigger),
            (this.useClosest = t.useClosest),
            (this.closeOnEscape = t.closeOnEscape),
            (this.showOnHover = t.showOnHover),
            (this.load = t.load),
            (this.ariaExpanded = void 0 === t.ariaExpanded || t.ariaExpanded),
            (this.onOpen = t.onOpen || function () {}),
            (this.onClose = t.onClose || function () {}),
            (this.content = this.target.querySelector("[data-content]")),
            (this.scrollElement =
              this.target.querySelector("[data-has-scroll]") || this.target),
            (this.togglers = t.toggler
              ? [t.toggler]
            ...
            this.checkStatus() &&
              ...
              this.open(),
            this.mediaQuery &&
              window.addEventListener("resize", this.checkStatus.bind(this)),
            (d[this.id] = this);
        }
        return (
          n(
            ...
            [
                ...
                value: function () {
                  ...
                  if (!this.isInit) {
                    this.target.classList.contains("active")
                      ? this.open()
                      : this.close(),
                      this.togglers.forEach(function (t) {
                        t.setAttribute("aria-controls", e.id),
                          t.addEventListener("click", function (t) {
                            t.preventDefault(),
                              e.disabled ||
                                (e.target.classList.contains("active")
                                  ? e.close(t.currentTarget)
                                  : e.open(t.currentTarget));
                          }),
                          e.showOnHover &&
              ...
              },
              {
                ...
                value: function () {
                  ...
                  this.isInit &&
                    ...
                    this.preventScroll && o(this.scrollElement),
                    this.setHeight &&
                      setTimeout(function () {
              ...
              },
              {
                key: "setText",
                value: function (e, t) {
                  var i = e.matches("[data-text-active][data-text-no-active]")
                    ? e
                    : e.querySelector(
                        "[data-text-active][data-text-no-active]"
                      );
                  i &&
                    (i.innerHTML = t
                      ? i.dataset.textActive
                      : i.dataset.textNoActive);
                },
              },
              {
                key: "open",
                  ...
                  this.target.classList.add("active"),
                    ...
                    this.togglers.forEach(function (e) {
                      e.classList.add("active"),
                        t.setText(e, 1),
                        t.ariaExpanded && e.setAttribute("aria-expanded", !0);
                    }),
                    this.preventScroll && a(this.scrollElement),
                    this.target
                      .querySelectorAll("iframe")
                      .forEach(function (e) {
                        !e.src &&
                          e.dataset.src &&
                          ((e.src = e.dataset.src), (e.hidden = !1));
                      }),
                    this.target
                    ...
                    e && e.dataset.setFocus && $(e.dataset.setFocus).focus(),
                    (this.load && !this.loaded) ||
                      this.load ||
                      this.loaded ||
                      (c[this.id] && c[this.id](this), (this.loaded = !0)),
                    document.documentElement.classList.add(this.id + "-active"),
                    this.useClosest,
                    this.closeOnEscape && l.push(this),
                    this.onOpen();
                },
              },
              {
                  ...
                  this.target.classList.remove("active"),
                    ...
                    this.togglers.forEach(function (t) {
                      t.classList.remove("active"),
                        e.setText(t, 0),
                        e.ariaExpanded && t.setAttribute("aria-expanded", !1);
                    }),
                    this.preventScroll && o(this.scrollElement),
                    this.target
                      .querySelectorAll("iframe")
    ...
    e.exports = (function (e) {
      ...
      function (e, t, i) {
        ...
        (i(3).inspectSource = function (e) {
          ...
          (e.exports = function (e, t, i, o) {
            ...
            c && (r(i, "name") || s(i, "name", t)),
              e[t] !== i &&
                (c &&
                  (r(i, a) || s(i, a, e[t] ? "" + e[t] : l.join(String(t)))),
                e === n
                  ? (e[t] = i)
                  : o
                  ? e[t]
        ...
        var l = (function () {
          function e(t, i) {
            (function (e, t) {
              ...
              (this.scrollbarWidth = (0, r.default)()),
              (this.offsetSize = 20),
            ...
            (function (e, t, i) {
                ...
                },
                {
                  ...
                  value: function () {
                    ...
                    this.options.autoHide &&
                      ...
                      (this.resizeObserver = new o.default(
                ...
                },
                {
                  ...
                  value: function () {
                    ...
                    "x" === r
                      ? ((e = this.trackX),
                        (t = this.scrollbarX),
                        (i = this.contentEl[this.scrollOffsetAttr[r]]),
                        (n = this.contentSizeX),
                        (s = this.scrollbarXSize))
                      : ((e = this.trackY),
                        (t = this.scrollbarY),
                        (i = this.scrollContentEl[this.scrollOffsetAttr[r]]),
                        (n = this.contentSizeY),
                        (s = this.scrollbarYSize));
                    var a = s / n,
                      o = i / (n - s),
                      l = Math.max(~~(a * s), this.options.scrollbarMinSize),
                      c = ~~((s - l) * o);
                    (this.isVisible[r] = s < n),
                      this.isVisible[r] || this.options.forceVisible
              ...
              [
                ...
                },
                {
                  key: "getElOptions",
                  value: function (t) {
                    return Object.keys(e.htmlAttributes).reduce(function (
                      i,
                      n
                    ) {
                      ...
                      return (
                        t.hasAttribute(s) &&
                          (i[n] = JSON.parse(t.getAttribute(s) || !0)),
                        i
                      );
                    },
                    {});
      ...
      function (e, t, i) {
        ...
        e.exports = function (e, t, i, v, m, g, y) {
          ...
          if (
            (P &&
              (E = u(P.call(new e()))) !== Object.prototype &&
              E.next &&
              (d(E, S, !0), n || o(E, h) || a(E, h, f)),
            C &&
              M &&
              "values" !== M.name &&
              ((T = !0),
      ...
      function (e, t, i) {
        ...
        e.exports = i(7)
          ...
          : function (e, t) {
              s(e);
              for (var i, a = r(t), o = a.length, l = 0; o > l; )
                n.f(e, (i = a[l++]), t[i]);
              return e;
            };
      },
          ...
          "Array",
          {
            from: function (e) {
              var t,
                ...
                y = d(h);
              if (
                (m && (v = n(v, f > 2 ? arguments[2] : void 0, 2)),
                null == y || (p == Array && o(y)))
              )
                for (i = new p((t = l(h.length))); t > g; g++)
                  c(i, g, m ? v(h[g], g) : h[g]);
              else
                for (u = y.call(h), i = new p(); !(s = u.next()).done; g++)
                  c(i, g, m ? a(u, v, [s.value, g], !0) : s.value);
              return (i.length = g), i;
            },
          }
        );
      ...
      function (e, t, i) {
        var n,
          s,
          r; /*! scrollbarWidth.js v0.1.3 | felixexter | MIT | https://github.com/felixexter/scrollbarWidth */
        (s = []),
          void 0 !==
            (r =
              "function" ==
        ...
        (function (t) {
          ...
          e.exports = function (e, t, r) {
            ...
            return (
              ...
              i(r) &&
                ((E = !!r.leading),
                (p = (x = "maxWait" in r) ? m(n(r.maxWait) || 0, t) : p),
      ...
      function (e, t, i) {
        ...
        function r(e) {
          ...
          var r = getComputedStyle(e),
            a = (function (e) {
              for (
                var t = {}, i = 0, s = ["top", "right", "bottom", "left"];
                i < s.length;
                i += 1
              ) {
                var r = s[i],
          ...
          if (
            ("border-box" === r.boxSizing &&
              (Math.round(d + l) !== t && (d -= s(r, "left", "right") + l),
              Math.round(u + c) !== i && (u -= s(r, "top", "bottom") + c)),
            !(function (e) {
  ...
  function (e, t, i) {
    ...
    var o = i(1),
      ...
      d =
        (new ((function () {
          function e(t) {
            ...
            !(function (e, t) {
              ...
              this.DOM.toggleCtrl.forEach(function (e) {
                return e.addEventListener("click", function () {
                  i.active ? i.close() : i.open();
                });
              }),
              (this.DOM.items = this.DOM.el.querySelectorAll(
                ".main-menu-block__inner"
              ));
          }
          return (
            s(e, [
              ...
              },
              {
                ...
                value: function (e) {
                  ...
                  if (!this.isAnimated) {
                    (this.isAnimated = !0),
                      this.DOM.el.classList.toggle("active", "open" === e),
                      this.DOM.toggleCtrl.forEach(function (t) {
                    ...
                    i ||
                      this.DOM.items.forEach(function (t) {
                        var s = t.querySelector(
                            ".main-menu-block__inner-content"
                          ),
                          r = +t.dataset.item,
                          o = {
                            translateX: 0,
                        ...
                        0 === r
                          ...
                          0 === r
                            ...
                            : 6 === r &&
                              ((c.translateX = [0, "-101%"]),
                              (d.translateX = [0, "-51%"])),
                          (o.delay = l.delay = c.delay = d.delay = u),
                          "open" == e
                            ? ((0, a.default)(o), (0, a.default)(l))
                            : ((0, a.default)(c), (0, a.default)(d));
                      }),
                      "open" === e
                        ...
                        : setTimeout(function () {
                            (t.DOM.el.style.visibility = ""),
                              document.documentElement.classList.remove(
                                "menu-active"
                              );
                          }, n * (this.DOM.items.length - 1)),
                      setTimeout(function () {
                        t.isAnimated = !1;
                      }, n * (this.DOM.items.length - 1)),
                      this.DOM.el.setAttribute("aria-hidden", this.active),
        ...
        document.getElementById("menu-soc-links-current-link"));
