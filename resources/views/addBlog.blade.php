            ...
            <div class="tab-content" id="pills-tabContent">
                ...
                <div class="tab-pane fade" id="pills-ru" role="tabpanel" aria-labelledby="pills-ru-tab">
                    <div class="mb-3">
                        ...
                        <input class="form-control" type="text" id="title_ru" name="title_ru" placeholder="Title"/>
                    </div>
                ...
                <div class="tab-pane fade" id="pills-eng" role="tabpanel" aria-labelledby="pills-eng-tab">
                    <div class="mb-3">
                        ...
                        <input class="form-control" type="text" id="title_en" name="title_en" placeholder="Title"/>
                    </div>
