...
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        ...
        <small class="text-muted">Заполните все необходимые поля для создания вакансии</small>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-lg-8">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <!-- Название вакансии (только для тестирования) -->
                    <div class="alert alert-info">
                        <i class="fas fa-info-circle me-2"></i>
                        <strong>Временная форма для тестирования</strong><br>
                        Потом эта форма будет убрана из админки и станет публичной.
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('description_tm') is-invalid @enderror" 
                                  id="description_tm" 
                                  name="description_tm" 
                                  rows="4">{{ old('description_tm') }}</textarea>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('requirements_ru') is-invalid @enderror" 
                                  ...
                                  rows="3">{{ old('requirements_ru') }}</textarea>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('requirements_en') is-invalid @enderror" 
                                  ...
                                  rows="3">{{ old('requirements_en') }}</textarea>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('requirements_tm') is-invalid @enderror" 
                                  ...
                                  rows="3">{{ old('requirements_tm') }}</textarea>
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select @error('employment_type') is-invalid @enderror" 
                            ...
                            <option value="contract" {{ old('employment_type') == 'contract' ? 'selected' : '' }}>Контракт</option>
                            <option value="freelance" {{ old('employment_type') == 'freelance' ? 'selected' : '' }}>Фриланс</option>
                            <option value="internship" {{ old('employment_type') == 'internship' ? 'selected' : '' }}>Стажировка</option>
                        </select>
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select @error('experience_level') is-invalid @enderror" 
                            ...
                            <option value="intern" {{ old('experience_level') == 'intern' ? 'selected' : '' }}>Стажер</option>
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select @error('job_positions') is-invalid @enderror" 
                            ...
                            @foreach(\App\Models\JobPosition::active()->ordered()->get() as $position)
                                <option value="{{ $position->id }}" {{ in_array($position->id, old('job_positions', [])) ? 'selected' : '' }}>
                                    {{ $position->name_ru }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select @error('technical_skills') is-invalid @enderror" 
                            ...
                            @foreach(\App\Models\TechnicalSkill::active()->ordered()->get() as $skill)
                                <option value="{{ $skill->id }}" {{ in_array($skill->id, old('technical_skills', [])) ? 'selected' : '' }}>
                                    {{ $skill->name_ru }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select @error('work_formats') is-invalid @enderror" 
                            ...
                            @foreach(\App\Models\WorkFormat::active()->ordered()->get() as $format)
                                <option value="{{ $format->id }}" {{ in_array($format->id, old('work_formats', [])) ? 'selected' : '' }}>
                                    {{ $format->name_ru }}
                                </option>
                            @endforeach
                        </select>
