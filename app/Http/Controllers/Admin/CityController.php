...
class CityController extends Controller
{
    public function index()
    {
        ...
        if (!Auth::user()->hasPermission(Permissions::CITIES_VIEW)) {
    ...
    public function create()
    {
        ...
        if (!Auth::user()->hasPermission(Permissions::CITIES_CREATE)) {
    ...
    public function edit(City $city)
    {
        ...
        if (!Auth::user()->hasPermission(Permissions::CITIES_EDIT)) {
    ...
    public function destroy(City $city)
    {
        ...
        if (!Auth::user()->hasPermission(Permissions::CITIES_DELETE)) {
