...
class TechnicalSkillController extends Controller
{
    public function index()
    {
        ...
        if (!Auth::user()->hasPermission(Permissions::SKILLS_VIEW)) {
    ...
    public function create()
    {
        ...
        if (!Auth::user()->hasPermission(Permissions::SKILLS_CREATE)) {
    ...
    public function edit(TechnicalSkill $technicalSkill)
    {
        ...
        if (!Auth::user()->hasPermission(Permissions::SKILLS_EDIT)) {
    ...
    public function destroy(TechnicalSkill $technicalSkill)
    {
        ...
        if (!Auth::user()->hasPermission(Permissions::SKILLS_DELETE)) {
